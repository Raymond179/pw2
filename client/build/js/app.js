...
;app.service('userProfile', function($q, Auth, Restangular) {
  ...
  $templateCache.put('index.html',
    ...
    "            }\r" +
    "\n" +
    "            loadCSS('/css/not-critical.css?v=@@TIMESTAMP@@');</script><noscript><link rel=stylesheet href=\"/css/app.css?v=@@TIMESTAMP@@\"></noscript><script src=/js/ffo.js></script><script>var observer = new FontFaceObserver('source-sans-pro');\r" +
    "\n" +
    "\r" +
    "\n" +
