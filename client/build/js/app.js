...
;app.service('userProfile', function($q, Auth, Restangular) {
  ...
  $templateCache.put('index.html',
    ...
    "\n" +
    "  </script><![endif]--><html lang=en ng-app=bundlin id=ng-app><head><meta charset=UTF-8><title ng-bind=SEO.title>Bundlin - the beauty of the web, bundled.</title><meta name=fragment content=!><style>.bln-app {font-family: Helvetica, Arial, sans-serif;}\r" +
    "\n" +
    "            .font-loaded .bln-app {font-family: 'source-sans-pro', Helvetica, Arial, sans-serif;}\r" +
    "\n" +
    "\r" +
    "\n" +
    "            .bln-sidebar {\r" +
